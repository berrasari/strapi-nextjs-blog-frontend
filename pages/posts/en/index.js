    ...
    <div className="relative bg-transparent pt-16 pb-20 px-4 sm:px-6 lg:pt-24 lg:pb-28 lg:px-8">
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="text-center">
          ...
          <div className="block text-base text-center underline text-gray-600 font-semibold tracking-wide uppercase"><Link   href="./es">Cambiar idioma a español</Link></div>
        ...
        <div className="mt-12 max-w-lg mx-auto grid gap-5 lg:grid-cols-3 lg:max-w-none">
          {posts.data.map((post) => (
            ...
            >
              <Link href={"/posts/en/" + post.attributes.slug}>
